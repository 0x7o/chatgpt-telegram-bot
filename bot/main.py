...
def main():
    ...
    telegram_config = {
        ...
        "support_url": os.environ.get("SUPPORT_URL", "https://t.me/chatgpt_support"),
    }
    ...
    db = DB(
        db_name=os.environ.get("DB_NAME", "chatgpt"),
        user=os.environ.get("DB_USER", "chatgpt"),
        password=os.environ.get("DB_PASSWORD", "chatgpt"),
